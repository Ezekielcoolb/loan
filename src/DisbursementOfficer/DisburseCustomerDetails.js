    ...
    <CustomerDetailRap>
      <div className="client-1">
        ...
        <Icon
          ...
          <Link
            to={`/officer/customer/calender/${details[0]?.customerDetails?.bvn}`}
            className={`client-link ${
...
export default DisburseCustomerDetails;
