...
import { approveLoan, fetchWaitingLoans, rejectLoan, updateCallStatus } from "../redux/slices/LoanSlice";
      ...
      <div className="loan-details">
        ...
        <div className="right-loan-detail">
          <div className="verify-divs">
            ...
            <p>
              Click <Link to={`/manager/guarantorDetails/${id}`}>here</Link> to confirm if guarantor fill the guarantor
              form
            </p>
          </div>
