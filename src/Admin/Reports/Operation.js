...
const Operations = () => {
 const inputRef = useRef();
  ...
  const { loading, error, cashMessage, expenseMessage } = useSelector((state) => state.report);
...
const [uploadedImage, setUploadedImage] = useState(null);
  const {holidays, successHolidayMessage, holidayloading } = useSelector((state) => state.holiday);
      ...
      <tbody>
        {operations?.map((operation, idx) => (
          <tr key={operation.required} className="text-center">
            ...
            <td className="border px-2 py-1">
              <button onClick={()=> handleView(operation?.id)}>View</button>
            </td>
...
<div className="dropdown-container"> 
    ...
    <form onSubmit={handleSubmit}>
      ...
      <h3>Add Expense</h3>
       <Icon onClick={() => setExpenseShow(false)}
      ...
      />
       ...
       {uploadedImage && <PreviewImage src={uploadedImage} alt="Uploaded preview" />}
      <button className="submit-btn" type="submit" disabled={loading}>
        {loading ?  <PulseLoader color="white" size={10} /> : "Submit Expense"}
      </button>
</div>
    </form>
    </div>
...
<div className="dropdown-container"> 
 ...
 <form onSubmit={handleSubmitCash}>
    <div className="dropdown-header">
      <h3>Cash At Hand</h3>
       <Icon onClick={() => setCashAtHandShow(false)}
    ...
    <div className="dropdown-content">
      ...
      />
      <button className="submit-btn" type="submit" disabled={loading}>
        {loading ? <PulseLoader color="white" size={10} /> : "Submit Cash"}
      </button>
      </div>
    </form>
    </div>
...
<div className="dropdown-container"> 
 ...
 <form onSubmit={handleSubmitCash}>
    <div className="dropdown-header">
      <h3>Add Holiday</h3>
       <Icon onClick={() => setHolidayShow(false)}
