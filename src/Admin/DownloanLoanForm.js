  ...
  return (
    <DownloadRap>
        ...
        <Link
            ...
            <div style={{
                ...
                <div className="personal-Details">
                    ...
                    <div className="form-body-info-sub">
                        <h5>Years Known:</h5>
                        <p>
                        {loan?.guarantorDetails.yearsKnown}{" "}
                        {loan?.guarantorDetails.phoneTwo}
                        </p>
                    </div>
                    </div>
                ...
                <div className="personal-Details">
                    ...
                    <ol>
                        ...
                        <li>
                        I understand that any false or misleading information may lead
                        to rejection of my application and may also be punishable
                        under applicable laws. This includes, but is not limited to,
                        criminal prosecution and/or damages.
                        </li>
                        <li>
                        I have read, understood, and agreed to the Terms and
                        Conditions of JK SOLUTNS including the company's policies and
                        procedures. Additionally, I authorize JK SOLUTNS to verify the
                        information provided and conduct reference checks as required.
                        </li>
                    </ol>
                    </div>
            ...
            <button onClick={() => {
                                            generatePDF(formRef, { filename: `Loan form for ${loan.customerDetails.lastName} ${loan.customerDetails.firstName}` })
                                        }}>Download </button>      </div>
    </DownloadRap>
  );
};
